...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-100 text-gray-600 dark:bg-gray-900 dark:text-gray-300 py-8 shadow-[inset_0_10px_10px_-10px_rgba(0,0,0,0.3)] dark:shadow-[inset_0_10px_10px_-10px_rgba(255,255,255,0.1)]">
